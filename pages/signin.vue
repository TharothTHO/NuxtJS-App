<template>
  <div class="h-screen font-sans" style="background-image: url(https://t4.ftcdn.net/jpg/01/22/71/95/360_F_122719584_A863mvJEcEAnqmGQ4ky6RbXEhsHKw95x.jpg)" >
    <div class="container mx-auto h-full flex justify-center items-center">
        <div class="w-1/3">
            <h1 class="font-hairline mb-6 text-center text-4xl text-white">Welcome to our Website</h1>
            <div class="border-teal p-8 border-t-12 bg-white mb-6 rounded-lg shadow-lg">
                ...
                <div class="flex items-center justify-between">
                    <button class="bg-green-400 hover:bg-teal text-white font-bold py-2 px-4 rounded">
                        Login
                    </button>
