<template>
    ...
    <div class="container">
        ...
        <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="795.9" height="433" viewBox="0 0 795.9 433">
            ...
            <g class="page-fall2" <path class="medium_gray fade7" d="M795.9 103.8h-34.3s8.7 14.7 8 32c-.7 17.3 3.2 85.5 3.2 85.5H796V103.8z" />
            </g>
        ...
        <div class="text">
            ...
            <div id="home" class="button">
                <h3> <NuxtLink to="/">Back Home</NuxtLink> </h3>
            </div>
            </div>
